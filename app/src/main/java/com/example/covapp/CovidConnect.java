...
public class CovidConnect extends AppCompatActivity {
    private static final String TAG = "CovidUpdatesActivity";


    private String website_url = "https://health.maryland.gov/covidconnect/Pages/Home.aspx";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_covid_connect);
    ...
    public void webView(String website_url)
    {
        ...
        webView = findViewById(R.id.webview_covid_connect);     // initializing the webView to surveyPage( webView id in xml)
    ...
    private class MYBrowser extends WebViewClient
    {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url)
        {
            ...
            {
                startActivity(new Intent(CovidConnect.this, CovidConnect.class));
            }
            return false;
        }
    }
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.navigation_covidtracker:
                        startActivity(new Intent(CovidConnect.this, LocationTracer.class));
                        break;
                    case R.id.navigation_contacttracer:
                        startActivity(new Intent(CovidConnect.this, ContactTracerActivity.class));
                        break;
                    case R.id.navigation_covidupdates:
                        startActivity(new Intent(CovidConnect.this, CovidUpdatesActivity.class));
                        break;
                    case R.id.navigation_services:
                        startActivity(new Intent(CovidConnect.this, ServiceActivity.class));
                        break;
                }
                return true;
            }
    ...
    public void onBackPressed() {
        ...
        startActivity(new Intent(CovidConnect.this, DashboardActivity.class));
    }
